                ...
                <div id="chats" class="tab-pane active" role="tabpanel" aria-labelledby="chats-tab">
                            ...
                            <div class="overflow-x-auto scrollbar-hidden">
                                <div class="flex mt-5">
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        ...
                                        <div class="text-xs text-slate-500 truncate text-center mt-2">Kevin Spacey</div>
                                    </a>
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        ...
                                        <div class="text-xs text-slate-500 truncate text-center mt-2">Christian Bale</div>
                                    </a>
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-8.jpg">
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        ...
                                        <div class="text-xs text-slate-500 truncate text-center mt-2">Will Smith</div>
                                    </a>
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        ...
                                        <div class="text-xs text-slate-500 truncate text-center mt-2">Leonardo DiCaprio</div>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
                        ...
                        <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                            ...
                            <div class="w-5 h-5 flex items-center justify-center absolute top-0 right-0 text-xs text-white rounded-full bg-primary font-medium -mt-1 -mr-1">5</div>
                        </div>
                        <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-8.jpg">
                        ...
                        <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                            ...
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                                    <a href="javascript:;" class="font-medium">Will Smith</a> 
                                    <div class="text-xs text-slate-400 ml-auto">05:09 AM</div>
                                </div>
                                <div class="w-full truncate text-slate-500 mt-0.5">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomi</div>
                            </div>
                ...
                <div id="friends" class="tab-pane" role="tabpanel" aria-labelledby="friends-tab">
                    ...
                    <div class="chat__user-list overflow-y-auto scrollbar-hidden pr-1 pt-1">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            ...
                            <div class="dropdown ml-auto">
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="" class="dropdown-item"> <i data-feather="share-2" class="w-4 h-4 mr-2"></i> Share Contact </a>
                                        </li>
                                        <li>
                                            <a href="" class="dropdown-item"> <i data-feather="copy" class="w-4 h-4 mr-2"></i> Copy Contact </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            ...
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center"> <a href="" class="font-medium">Christian Bale</a> </div>
                                <div class="w-full truncate text-slate-500 mt-0.5">Last seen 2 hours ago</div>
                            </div>
                            <div class="dropdown ml-auto">
                                <a class="dropdown-toggle w-5 h-5 block" href="javascript:;" aria-expanded="false" data-tw-toggle="dropdown"> <i data-feather="more-horizontal" class="w-5 h-5 text-slate-500"></i> </a>
                    ...
                    <div class="pr-1">
                        <div class="box px-5 py-10 mt-5">
                            <div class="w-20 h-20 flex-none image-fit rounded-full overflow-hidden mx-auto">
                                <img alt="Icewall Tailwind HTML Admin Template" src="dist/images/profile-13.jpg">
                            </div>
                            <div class="text-center mt-3">
                                <div class="font-medium text-lg">Kevin Spacey</div>
                        ...
                        <div class="box p-5 mt-5">
                            ...
                            <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 py-5">
                                <div>
                                    ...
                                    <div class="mt-1">kevinspacey@left4code.com</div>
                                </div>
                            ...
                            <div class="flex items-center pt-5">
                                <div>
                                    ...
                                    <div class="mt-1">31 August 2021</div>
                                </div>
                ...
                <div class="hidden h-full flex flex-col">
                    <div class="flex flex-col sm:flex-row border-b border-slate-200/60 dark:border-darkmode-400 px-5 py-4">
                        ...
                        <div class="flex items-center sm:ml-auto mt-5 sm:mt-0 border-t sm:border-0 border-slate-200/60 pt-3 sm:pt-0 -mx-5 sm:mx-0 px-5 sm:px-0">
                            <a href="javascript:;" class="w-5 h-5 text-slate-500"> <i data-feather="search" class="w-5 h-5"></i> </a>
                            <a href="javascript:;" class="w-5 h-5 text-slate-500 ml-5"> <i data-feather="user-plus" class="w-5 h-5"></i> </a>
                            <div class="dropdown ml-auto sm:ml-3">
                                <a href="javascript:;" class="dropdown-toggle w-5 h-5 text-slate-500" aria-expanded="false" data-tw-toggle="dropdown"> <i data-feather="more-vertical" class="w-5 h-5"></i> </a>
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="" class="dropdown-item"> <i data-feather="share-2" class="w-4 h-4 mr-2"></i> Share Contact </a>
                    ...
                    <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
                        <div class="chat__box__text-box flex items-end float-left mb-4">
                            ...
                            <div class="hidden sm:block dropdown ml-3 my-auto">
                                <a href="javascript:;" class="dropdown-toggle w-4 h-4 text-slate-500" aria-expanded="false" data-tw-toggle="dropdown"> <i data-feather="more-vertical" class="w-4 h-4"></i> </a>
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="" class="dropdown-item"> <i data-feather="corner-up-left" class="w-4 h-4 mr-2"></i> Reply </a>
                                        </li>
                                        <li>
                    ...
                    <div class="pt-4 pb-10 sm:py-4 flex items-center border-t border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <div class="flex absolute sm:static left-0 bottom-0 ml-5 sm:ml-0 mb-5 sm:mb-0">
                            <div class="dropdown mr-3 sm:mr-5">
                                <a href="javascript:;" class="dropdown-toggle w-4 h-4 sm:w-5 sm:h-5 block text-slate-500" aria-expanded="false" data-tw-toggle="dropdown"> <i data-feather="smile" class="w-full h-full"></i> </a>
                        ...
                        <a href="javascript:;" class="w-8 h-8 sm:w-10 sm:h-10 block bg-primary text-white rounded-full flex-none flex items-center justify-center mr-5"> <i data-feather="send" class="w-4 h-4"></i> </a>
                    </div>
                </div>
                <!-- END: Chat Active -->
                <!-- BEGIN: Chat Default -->
