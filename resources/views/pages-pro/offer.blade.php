...
<div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="{{ route('addoffers.page') }}" class="btn btn-primary shadow-md mr-2">Add New Offer</a>
            ...
            <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 px-5 py-4">
                    ...
                    <div class="ml-3 mr-auto">
                        ...
                        <div class="flex text-slate-500 truncate text-xs mt-0.5"> <span class="mx-1">•posted at </span> {{$offer->posted_at}} </div>
                    </div>
                    <div class="dropdown ml-3">
                        ...
                        <div class="dropdown-menu w-40">
                            <ul class="dropdown-content">
                                <li>
                                    <a href="{{route('editoffers.page',$offer->id)}}" class="dropdown-item"> <i data-feather="edit-2" class="w-4 h-4 mr-2"></i> Edit Offer </a>
                                </li>
                                <li>
                                    <a onclick="filldelinfo(\"{{route('offers.del',$offer->id)}}\")" data-tw-toggle="modal" data-tw-target="#delete-modal-preview" class="dropdown-item cursor-pointer"> <i data-feather="trash" class="w-4 h-4 mr-2"></i> Delete Offer </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="p-5">
                    <div class="h-40 2xl:h-56 image-fit">
                        <img alt="Icewall Tailwind HTML Admin Template" class="rounded-md" src="{{$offer->portfolio}}" onerror="this.src='dist/images/placeholders/200x200.jpg'">
                    </div>
                    <a href="{{ $offer->mainlink }}" class="block font-medium text-base mt-5">{{$offer->name}}</a> 
                    <div class="text-slate-600 dark:text-slate-500 mt-2">{{$offer->brief_title}}</div>
                </div>
                <div class="px-5 pt-3 pb-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    <div class="w-full flex text-slate-500 text-xs sm:text-sm">
                        <div class="mr-2"> link: <span class="font-medium">{{$offer->mainlink}}</span> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    <div class="p-5 text-center">
                        ...
                        <div class="text-3xl mt-5">Are you sure you want to delete<br>this offer?
                        </div>
                        <div class="text-slate-500 mt-2">
                            This offer data will be deleted permanentely
                            <br>Please confirm
                        </div>
                    </div>
