...
<div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="{{route('addshares.page')}}" class="btn btn-primary shadow-md mr-2">Add New Share</a>
    ...
    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
            ...
            <div class="p-5">
                ...
                <img alt="Icewall Tailwind HTML Admin Template" class="rounded-md" src="{{$share->portfolio}}" onerror="this.src='dist/images/placeholders/200x200.jpg'">
                </div>
                <a href="" class="block font-medium text-base mt-5">{{$share->name}}</a> 
                <div class="text-slate-600 dark:text-slate-500 mt-2">{{$share->brief_title}}</div>
            </div>
