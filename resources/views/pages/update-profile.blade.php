    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                ...
                <div class="p-5">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('update-profile-act') }}">
                        @csrf
                                ...
                                <div class="grid grid-cols-12 gap-x-5">
                                    <div class="col-span-12 2xl:col-span-6">
                                        <div>
                                            ...
                                            <input name="name1" id="update-profile-form-1" type="text" class="form-control" placeholder="Input text" value="{{ $fakers[0]['users'][0]['name'] }}" disabled>
                                        </div>
                                        <div class="mt-3">
                                    ...
                                    <div class="col-span-12 2xl:col-span-6">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input name="phone1" id="update-profile-form-4" type="text" class="form-control" placeholder="Input text" value="65570828">
                                        </div>
                                    </div>
                            ...
                            <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                                <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                    ...
                                    <div class="mx-auto cursor-pointer relative mt-5">
                                        <!-- <button type="button" class="btn btn-primary w-full">Change Photo</button> top-0 left-0 absolute opacity-0 -->
                                        <input name="image1" type="file" class="w-full h-full">
                                    </div>
                                </div>
                            </div>
                        </div>
